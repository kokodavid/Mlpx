...
class _SyncStatusCard extends ConsumerWidget {
  ...
  Future<void> _handleSync(WidgetRef ref) async {
    ...
    try {
      ...
      print('[ReviewScreen] Unsynced lessons after sync: ${unsyncedAfter.length}');
      ...
      print('[ReviewScreen] Sync verification:');
      ...
      print('[ReviewScreen] Sync error: $e');
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: syncState.isSyncing ? null : () {
                    print('[ReviewScreen] Sync button pressed, isSyncing: ${syncState.isSyncing}');
                    _handleSync(ref);
                  },
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
            decoration: BoxDecoration(
              color: iconBackgroundColor ?? Colors.black.withOpacity(0.08),
              shape: BoxShape.circle,
            ),
