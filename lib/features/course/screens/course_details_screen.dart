...
class _CourseDetailsScreenState extends ConsumerState<CourseDetailsScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final courseAccessAsync = ref.watch(courseAccessProvider(widget.courseId));
    ...
    return Focus(
      ...
      child: Scaffold(
        ...
        body: completeCourseAsync.when(
          data: (completeCourse) {
            if (courseAccessAsync.isLoading) {
              return const Center(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      const Text(
                        'Complete your current course before opening the next one.',
                        style: TextStyle(
                          fontSize: 14,
                          color: AppColors.textColor,
                        ),
              ...
              child: SingleChildScrollView(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      if (accessState?.debugOverrideEnabled == true)
                        Container(
                          width: double.infinity,
                          ...
                          child: const Text(
                            'Debug override is enabled. Locked courses can be opened.',
                            style: TextStyle(
